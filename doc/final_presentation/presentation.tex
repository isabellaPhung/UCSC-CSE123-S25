...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{itemize}
      \item Durabilty testing
      \item Thermal testing 
      \item Battery life cycle testing
      \item Haptics and sound testing 
    \end{itemize}
  \end{columns}
  \note[item]{Durability testing: includes chemical testing, drop testing, tensile testing, UV testing}
  \note[item]{Battery life cycle: charge speed, battery degredation, battery life}
\end{frame}

\begin{frame}
  \frametitle{Test Results}
  %results of tests we dida
  \note
...
\begin{frame}
  ...
  \note[item]{A large space is necessary to fit two 18650 battery cells}
