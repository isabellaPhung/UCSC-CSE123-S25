...
\graphicspath{{../common/personas}{../common/}{images}{images/cmyk}}
\usepackage{booktabs}
\usepackage{tikz}
\usepackage{pgfplots}
...
\logoleft{\includegraphics[height=7cm]{University_of_California_Unofficial_Seal_CMYK.pdf}}
...
%  \end{block}
      ...
      \begin{block}{System Architecture}
        ...
        \begin{figure}
          ...
          \begin{subfigure}[t]{0.54\textwidth}
              \includegraphics[width =\textwidth]{product_components_CMYK.pdf}
              %\caption{Component Diagram}
          \end{subfigure}
          \begin{subfigure}[t]{0.44\textwidth}
              \includegraphics[width=\textwidth]{prototype_CMYK.pdf}
    ...
    \begin{column}{\colwidth} 
      ...
      \begin{block}{Goal Driven Design}
        \begin{center}
          \vskip 0.5cm
          \includegraphics[width = \textwidth]{entry_logic_CMYK.pdf}
        \end{center}
