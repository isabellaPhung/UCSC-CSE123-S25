  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{Introduction}
        ...
        \begin{itemize}
            \item Presence: Device must command user attention in a way that is systematic but not overly frequent.
            \item Configurable: Device software must be compatible with exsisting tools such as Google Calendar.
            \item Accessible: Device must integrate intuitive user interface and must contain backups for device failures. 
        \end{itemize}
